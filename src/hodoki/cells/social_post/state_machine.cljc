(ns hodoki.cells.social-post.state-machine
  "Phase state machine for the 解き — ELV Disassembly + Materials Recovery social_post cell — the publication membrane that
